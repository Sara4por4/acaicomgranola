            ...
            <div class="menu_section">
                <ul class="nav side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav child_menu">
                                   @can('index_translations')
                                    ...
                                    @endcan
                                    @if(Auth::user()->hasRole('sudo'))
                                        <li><a href="{{url('/')}}/sgc/category/translation">Categorias</a></li>
                                    @endif
                                    @can('index_translations')
                                        @foreach($categories->where('categorable', 'translation')->where('parent_id', 0)->get() as $value)
                                            <li>
                                                <a href="{{url('/')}}/sgc/translation/{{$value->id}}">{{$value->name}}</a>
                                            </li>
                                        @endforeach
                                    @endcan
                    ...
                    <li>
                        ...
                        <li>
                            <a><i class="fa fa-file"></i> Recrutamento <span class="fa fa-chevron-down"></span></a>

                            <ul class="nav child_menu">
                                <li><a href="{{url('/')}}/sgc/candidates">Candidaturas</a></li>
                            </ul>
                        </li>
